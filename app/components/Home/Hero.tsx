...
export default function HeroSection() {
  return (
    <section className="px-4 sm:px-6 pt-25 pb-20  bg-green-100 sm:pt-20 sm:pb-28 overflow-hidden w-screen">
      
    
      <div className="mx-auto max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
        
        {/* Lewa kolumna: Treść */}
        <div className="w-full lg:w-1/2 flex flex-col md:pt-15 md:pl-10 items-center text-center lg:items-start lg:text-left">
          
          <h1 className="font-headline text-4xl sm:text-5xl lg:text-[2.6rem] xl:text-6xl leading-[1.1] text-black/80">
            
              Ułóż i kontroluj swoją dietę z pomocą AI 
          </h1>
